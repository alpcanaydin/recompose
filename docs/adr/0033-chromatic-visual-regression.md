...
- **The UI Review feature as a second required check**: rejected. It stays an informational lane; requiring it would gate every merge on two approvals from the same person.
