...
- `apps/desktop/src/main/subscriptions/macos-keychain.ts`: the `security` spawn for read, write, delete, and attributes, with the e2e keychain override, shell-thin (create)
