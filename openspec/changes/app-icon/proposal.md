...
- **The appearances vary the tile, never the note.** The note geometry stays identical across every Icon Composer appearance. Dark deepens the tile toward `#0C1341` and `#020309` and drops the light outer band. Mono is the note alone, matching the tray discipline, and the system derives clear and tinted from mono.
