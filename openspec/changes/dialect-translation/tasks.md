...
- [ ] **Task 6: the Responses codec.** Owns `packages/engine/src/dialect/responses-codec.ts`, its spec, its testkit, and `responses-drops.ts`. Depends on tasks 1, 2, 3, and 4. Runs beside task 5 on disjoint files.
